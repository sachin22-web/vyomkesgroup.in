...
export default function AdminAudit() {
  ...
  return (
    <>
      <Seo title="Admin Audit Logs" description="View system audit logs and activity records." />
      <div className="grid gap-4">
        <h1 className="text-2xl font-semibold">Audit Logs</h1> {/* Changed to h1 */}

        <Img
          src="/images/admin_audit_logs.jpg"
          alt="Admin audit logs and security monitoring"
